...
def make_pipeline():
    ...
    buy = fe.ConsensusRecommendations.buy.latest
    over = fe.ConsensusRecommendations.over.latest
    hold = fe.ConsensusRecommendations.hold.latest
    under = fe.ConsensusRecommendations.under.latest
    sell = fe.ConsensusRecommendations.sell.latest
    total = fe.ConsensusRecommendations.total.latest
    no_rec = fe.ConsensusRecommendations.no_rec.latest
    mark = fe.ConsensusRecommendations.mark.latest
